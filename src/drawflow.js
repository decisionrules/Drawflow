export default class Drawflow {
    ...
    if(this.connection === true) {
      ...
      if(ele_last.classList[0] === 'input' || (this.force_first_input && (ele_last.closest(".drawflow_content_node") != null || ele_last.classList[0] === 'drawflow-node'))) {
        ...
        if(output_id !== input_id && input_class !== false) {
          this.dispatch('beforeConnectionCreated', { output_id: id_output, input_id: id_input, output_class:  output_class, input_class: input_class});
  ...
  createReroutePoint(ele) {
    this.dispatch('beforeReroute', nodeId);
    this.connection_selected.classList.remove("selected");
  ...
  removeNodeId(id) {
    ...
    if(this.module === moduleName && this.container.querySelector(`#${id}`)) {
