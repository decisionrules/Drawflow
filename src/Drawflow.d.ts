...
export default class Drawflow {
     ...
     * @param callback
     */
    on(eventName: 'beforeNodeCreated', callback: (event: any) => void): void;
     ...
     * @param callback
     */
    on(eventName: 'beforeNodeMoved', callback: (event: any) => void): void;

    /**
     * beforeConnectionRemoved
     * @param eventName
     * @param callback
     */
    on(eventName: 'beforeConnectionRemoved', callback: (event: any) => void): void;
     ...
     * @param callback
     */
    on(eventName: 'beforeNodeRemoved', callback: (event: any) => void): void;
